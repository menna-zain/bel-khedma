...
//         // تحويل الـ delivery
//         const deliveryRequests: Request[] = (data.delivery || []).map((req: any) => ({
//           id: req.id,
//           serviceType: req.serviceType,
//           status: req.status,
//           startLocation: req.PLat && req.PLong ? `${req.PLat}, ${req.PLong}` : "N/A",
//           endLocation: req.DLat && req.DLong ? `${req.DLat}, ${req.DLong}` : "N/A",
//           averageTime: req.averageTime || null,
//         }));

//         // تحويل الـ transportation
//         const transportationRequests: Request[] = (data.transportation || []).map((req: any) => ({
//           id: req.id,
//           serviceType: req.serviceType,
//           status: req.status,
//           startLocation: req.SLat && req.SLong ? `${req.SLat}, ${req.SLong}` : "N/A",
//           endLocation: req.DLat && req.DLong ? `${req.DLat}, ${req.DLong}` : "N/A",
//           carType: req.carType || "N/A",
//         }));
...
//     const hrs = Math.floor(minutes / 60);
//     const mins = minutes % 60;
//     return mins === 0 ? `${hrs} hr${hrs > 1 ? "s" : ""}` : `${hrs} hr${hrs > 1 ? "s" : ""} ${mins} min`;
//   };
...
//               >
//                 <div className="flex justify-between items-center mb-2">
//                   <h2 className="text-lg font-bold text-gray-800">{request.serviceType}</h2>
//                   <span className="text-sm font-medium">{request.status}</span>
//                 </div>

//                 <div className="text-sm text-gray-700 flex flex-col gap-1">
//                   <p>
//                     <span className="font-medium">From:</span> {request.startLocation}
//                   </p>
//                   <p>
//                     <span className="font-medium">To:</span> {request.endLocation}
//                   </p>
//                   {request.averageTime && (
//                     <p>
//                       <span className="font-medium">Arrival Time:</span> {formatTime(request.averageTime)}
//                     </p>
//                   )}
//                   {request.carType && (
//                     <p>
//                       <span className="font-medium">Car Type:</span> {request.carType}
//                     </p>
//                   )}
//                 </div>
//               </div>
